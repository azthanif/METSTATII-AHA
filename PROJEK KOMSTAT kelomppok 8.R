    ...
    do.call(argonTabItems, c(
      list(
        argonTabItem(
          ...
          # --- BARIS KEDUA (2 KARTU, DIPOSISIKAN DI TENGAH) ---
          argonRow(
            center = TRUE,
            class = "mb-4",
            # Kartu 4: Data & File
            argonColumn(
              width = 4,
              tags$a(
                href = "https://drive.google.com/drive/folders/1HaLG56xAnmE9y-78iRJlZsSG7_t6N4tV?usp=sharing",
                target = "_blank",
                style = "text-decoration: none; color: inherit;",
                div(
                  class = "card argon-card card-stats",
                  ...
                  div(
                    class = "card-body",
                    div(
                      class = "icon icon-shape icon-shape-info",
                      icon("folder-open")
                    ),
                    h3("Data & File", class = "card-title"),
                    h5("Sumber Daya Proyek", class = "card-category"),
                    p("Klik untuk membuka folder Google Drive berisi file pendukung proyek.")
                  )
                )
              )
            ),
          
            # Kartu 5: Video Tutorial (Link ke Bagian Video)
            argonColumn(
              width = 4,
              div(
                class = "card argon-card card-stats",
    ...
    div(
      ...
      fluidRow(
        ...
        column(
          ...
          br(),
          tags$a(href = "https://github.com/azthanif/METSTATII-AHA", target = "_blank", icon("github"), " Lihat Kode Sumber di GitHub")
        )
      )
    )
  )
